...
export function Header({
  ...
  return (
    <header className="h-12 shrink-0 flex items-center px-4 bg-ground-100 border-b border-ground-300 gap-4">
      <span className="font-display font-semibold text-[15px] tracking-[0.02em] text-ink-000">Q-resQ NER</span>
      <span className="font-data text-[12px] text-ink-200">AIZAWL DISTRICT · MIZORAM</span>
      {view === "dashboard" && (
        <button
